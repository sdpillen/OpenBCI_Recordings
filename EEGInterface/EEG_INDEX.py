...
other values, but we'll go ahead and keep a backup eeg_index anyway. Concurrency issues for a single float value have never been an issue for me (in a lot of data collection).
"""
CURR_EEG_INDEX = 0
CURR_EEG_INDEX_2 = 0
